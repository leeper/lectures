...
\imageslide{width=\textwidth}{images/david-cameron.png}

\imageslide{height=\textheight}{images/ukip-pledge.png}
...
\imageslide{height=\textheight}{images/government-leaflet}

\imageslide{width=\textwidth}{images/brexit-bus}
...
\frame{
\begin{center}
\colorbox{white}{\includegraphics[width=\textwidth]{images/referendum-polling.png}}
\end{center}
}
...
\imageslide{width=\textwidth}{images/sample-ballot}

\imageslide{width=\textwidth}{images/economist-result}

\imageslide{height=\textheight}{images/eu-commission}
\imageslide{height=\textheight}{images/westminster}


\imageslide{height=\textheight}{images/referendum-map}
\imageslide{height=\textheight}{images/referendum-map-london}
...
\imageslide{width=\textwidth}{images/wages-scatterplot}
...
\begin{center}
\includegraphics[height=\textheight, trim = {1cm 1cm 1cm 3cm}, clip]{images/wordcloud4-all}
\end{center}
\hltfootnote
}
...
\imageslide{width=\textwidth}{images/northern-ireland-border}
...
\imageslide{height=\textheight}{images/city-of-london}
...
\item<4-> Voters divided on what they want from Brexit and views of what impact it will have
