...
\date[]{16 January 2017\\LSE Executive MSc Behavioural Science}
...
\item Assistant Professor at London School of Economics since 2015
\item Postdoc at Aarhus University 2012--2015
\item PhD in Political Science from Northwestern University (2012)
\item Interested in:
	\begin{itemize}
...
\item<5-> Attitudes are relatively easy to measure on questionnaire/survey methods
\end{itemize}
}


\frame{
\frametitle{Why should behavioural scientists care about behaviours?}
\begin{itemize}\itemsep1em
\item<2-> Behaviours are (often) public
\item<3-> Behaviours are (often) politically, economically, and socially consequential
\item<4-> Behaviours go beyond ``cheap talk''
	\begin{itemize}
	\item Greater construct validity
	\item More reliable/stable
	\item etc.
	\end{itemize}
\end{itemize}
}
...
\begin{itemize}\itemsep1em
\item<2-> \textit{Theory of Reasoned Action} (Ajzen \& Fishbein)
	\begin{itemize}
	\item Attitudes interact with ``subjective norms''
	\end{itemize}
\item<3-> \textit{Theory of Planned Behavior} (Ajzen)
	\begin{itemize}
	\item Attitudes interact with both subjective norms and ``perceived behavioural control''
	\end{itemize}
\item<4-> \textit{MODE} (Fazio)
	\begin{itemize}
	\item Adds a motivation and opportunity ``dual process'' framework to attitude--behaviour linkages
	\end{itemize}
\end{itemize}
...
\frametitle{Problems with behavioural self-reports}
...
\frame{\includegraphics[height=\textheight]{images/hainmuelleretal.png}}
...
\item Self-report measures have many problems
