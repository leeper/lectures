...
\title{Tips for Working Reproducibly}
\author[]{Thomas J. Leeper}
\institute[]{
  \inst{}%
  Senior Vising Fellow in Methodology\\London School of Economics and Political Science
}
...
\frametitle{Tools We'll See Today}
...
\item dropbox (\url{https://www.dropbox.com/})
\item google drive (\url{https://drive.google.com/})
\end{itemize}
...
\item Me:
	...
	\item Experimental and computational methods
	\item R
	\end{itemize}
...
\item Define reproducibility and replicability
...
\item Understand how to collaborate reproducibly
\end{enumerate}
...
\frametitle{Some Semantics}

\begin{itemize}\itemsep1em
\item Reproduction: recreating output from a shared input
\item Replication: creating new output from new input
\end{itemize}

\vspace{1em}

\url{https://thomasleeper.com/2015/05/open-science-language/}
}

\frame{

\frame{Beyond Scope for Today}

\begin{itemize}
\item Verification
\item Data Transparency
\item Replication
\item Non-computational reproducibility
	\begin{itemize}
	\item Software and hardware versioning
	\item Deterministic computing
...
\onslide<1->{
\begin{quote}
Beginning at the mouth of the Missouri, you will take observations of latitude and longitude at all remarkable points on the river\dots
\end{quote}
}

\onslide<2>{
\begin{quote}
The courses of the river between these points of observation may be supplied by the compass, the logline \& by time, corrected by the observations themselves. The variations of the compass too, in different places should be noticed
\end{quote}
}
}
...
\frametitle{\dots and finally:}

\begin{quote}
To provide, on the accident of your death, against anarchy, dispersion \& the consequent danger to your party, and total failure of the enterprise, you are hereby authorised, by any instrument signed \& written in your own hand, to name the person among them who shall succeed to the command
\end{quote}
...
\url{https://ajps.org/ajps-replication-policy/}
...
\frame{
	...
	\begin{itemize}
	\item \texttt{paper03-05-18.docx}
	\item \texttt{paper3-5-18.docx}
	\item \texttt{paper05-03-18.docx}
	\item \texttt{paper5-3-18.docx}
	\item \texttt{paper18-3-5.docx}
	\item \texttt{paper18-5-3.docx}
	\item \texttt{paper03-05.docx}
	\item \texttt{paper05-03.docx}
	\item \texttt{paper3-5.docx}
	\item \texttt{paper5-3.docx}
	\end{itemize}
}
...
There is only one way to write dates:
...
\begin{itemize}
\item Unambiguous
\item Sortable by most-to-least important digits
...
\frame{
	...
	\onslide<2->{Everything you do should be plain text*}
	
	\vspace{3em}
	
	{\footnotesize * Exceptions to this are images (sometimes)}
}
...
\begin{itemize}\itemsep1em
\item Never type/format citations manually!

\item Use reference management software
...
\item Develop a workflow where these are automatically generated
\end{itemize}
...
% common mistakes (making assumptions about environments and workflows): setwd(), point-and-click; software versions
...
%% https://doi.org/10.7910/DVN/THJYQR (H,H,Y)
%% http://economics.mit.edu/faculty/angrist/data1/mhe (A,P)
%% 
...
\section[Keeping]{Keeping Things}
\frame{\tableofcontents[currentsection]}
...
There are two considerations related to how you keep and store your research materials:

\begin{enumerate}\itemsep1em
\item Collaborating with yourself or others in the future

	\begin{itemize}
	\item Going back in time for long-lived projects
	\item Verification or reproducibility requests
	\end{itemize}

\item Collaborating with others now
...
\frame{
\begin{center}
\includegraphics[width=\textwidth]{images/atlassian-branching-2.png}
\end{center}
}
...
\frame{
\frametitle{Other stuff we didn't get to}

\begin{itemize}\itemsep1em
\item Project management and collaboration
\item Reproducible data gathering and protocols
\item Licensing and copyright
\item Data privacy and anonymization
\item Writing and distributing packages
\end{itemize}
