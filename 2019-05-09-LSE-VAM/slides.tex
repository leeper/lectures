...
\institute[]{
  \inst{}%
  Senior Visiting Fellow in Methodology\\London School of Economics and Political Science
}
...
\item \textbf{Reproduction}: recreating output from a shared input
\item \textbf{Replication}: creating new output from new input
\end{itemize}
...
\frametitle{Beyond Scope for Today}
...
\onslide<2->{Jefferson's instructions:}\\
